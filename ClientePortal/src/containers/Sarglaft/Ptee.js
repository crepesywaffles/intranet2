...
import {btnFormatos,btnVideos,btnManual,btnCodigoEtica,btnReglamento,headerptee,btnlineaEtica,lineaEtica} from "../../assets/sagrilaft/index"
...
export default class Ptee extends Component {
    ...
    render() {
        ...
        return (
            <Layout>
                <Image src={headerptee} as={Link} to={paths.CON_SARGLAFT} fluid/>
                <Grid centered={true} stackable  verticalAlign="middle" >
                    ...
                    <Grid.Column width={4}>
                        <Modal
                            ...
                            >
                                <Container>
                                <iframe src="https://cdn.flipsnack.com/widget/v2/widget.html?hash=znfgm8j7t9" width="100%" height="480" seamless="seamless" scrolling="no" frameBorder="0" allowFullScreen></iframe>
                                </Container>
                        </Modal>
                    </Grid.Column>
                    <Grid.Column width={4}>
