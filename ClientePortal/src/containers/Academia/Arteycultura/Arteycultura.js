...
import {Formaciones,Videos,Podcast,Articulos} from "../../../assets/academia/ACT/index"
import {Grid,Image,Divider} from "semantic-ui-react"
import {Link} from "react-router-dom"
import *as paths from "../../../config/routing/paths"

export default class Arteycultura extends Component {
    render() {
        return (
            <Layout>
                 <Grid centered={true}  verticalAlign="middle"columns={2}>
                    <Grid.Column>
                        ...
                        <Image as={Link} to={paths.CON_ACADEMIA_AC_VIDEOS} className="botonimg" src={Videos} size="medium" />
